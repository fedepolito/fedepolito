...
|---|---|---|
| [Maratón Ituzaingó](https://github.com/fedepolito/maraton-ituzaingo) | Sistema de inscripción y gestión de participantes para evento deportivo | PHP · MySQL · JavaScript |
| [Portal de Veterinaria](https://github.com/fedepolito/portal-veterinaria) | Gestión de turnos y pacientes para clínica veterinaria | Python |
| [Jarvis](https://github.com/fedepolito/jarvis) | Asistente de escritorio con comandos de voz | Python · Tkinter · SpeechRecognition |
| [Venta de Entradas](https://github.com/fedepolito/venta-entradas) | Sistema de compra y gestión de tickets para eventos | HTML · CSS · JS · PHP · MySQL |
